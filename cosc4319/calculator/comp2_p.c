...
/* Object interface: Icomputation2, ver. 0.0,
   GUID={0x96CCE1ED,0x8884,0x48C7,{0xA1,0x28,0x77,0x0A,0x5A,0x0F,0xB1,0x78}} */


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO Icomputation2_ServerInfo;
...
static const unsigned short Icomputation2_FormatStringOffsetTable[] = 
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_SERVER_INFO Icomputation2_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    &Icomputation2_FormatStringOffsetTable[-3],
    0,
    0,
    0,
    0
...
static const MIDL_STUBLESS_PROXY_INFO Icomputation2_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &Icomputation2_FormatStringOffsetTable[-3],
...
CINTERFACE_PROXY_VTABLE(15) _Icomputation2ProxyVtbl = 
{
    &Icomputation2_ProxyInfo,
    &IID_Icomputation2,
    ...
    (void *)-1 /* Icomputation2::ClearList */ ,
    (void *)-1 /* Icomputation2::AddNumList */ ,
    (void *)-1 /* Icomputation2::CalcAvg */ ,
    (void *)-1 /* Icomputation2::CalcSum */ ,
    (void *)-1 /* Icomputation2::StdDev */ ,
    (void *)-1 /* Icomputation2::NPR */ ,
    (void *)-1 /* Icomputation2::NCR */ ,
    (void *)-1 /* Icomputation2::Factorial */
};


static const PRPC_STUB_FUNCTION Icomputation2_table[] =
{
...
CInterfaceStubVtbl _Icomputation2StubVtbl =
{
    &IID_Icomputation2,
    &Icomputation2_ServerInfo,
    15,
    &Icomputation2_table[-3],
...
#ifndef _ALPHA_
#if !defined(_MIPS_) && !defined(_PPC_)
/* 142 */	NdrFcShort( 0x1c ),	/* x86 Stack size/offset = 28 */
#else
...
const CInterfaceProxyVtbl * _comp2_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_Icomputation2ProxyVtbl,
    0
};

const CInterfaceStubVtbl * _comp2_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_Icomputation2StubVtbl,
    0
};

PCInterfaceName const _comp2_InterfaceNamesList[] = 
{
    "Icomputation2",
    0
};

const IID *  _comp2_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _comp2_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _comp2, pIID, n)

int __stdcall _comp2_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_comp2_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo comp2_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _comp2_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _comp2_StubVtblList,
    (const PCInterfaceName * ) & _comp2_InterfaceNamesList,
    (const IID ** ) & _comp2_BaseIIDList,
    & _comp2_IID_Lookup, 
    1,
    2,
